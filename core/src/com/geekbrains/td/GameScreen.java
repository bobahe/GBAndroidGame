    ...
    public void createGUI() {
        ...
        btnSetTurret1.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                turretEmitter.buildTurret(player, TurretType.RED, selectedCellX, selectedCellY);
            }
        });
        ...
        btnSetTurret2.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                turretEmitter.buildTurret(player, TurretType.BLUE, selectedCellX, selectedCellY);
            }
        });
